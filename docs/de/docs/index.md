...
`gamspreprocessor` ist eine Sammlung von Command Line Werkzeugen für die
Erzeugung und Verwaltung von GAMS **Objektverzeichnissen**, die als
...
[Befehlsreferenz](command-reference/gamspreprocessor/)