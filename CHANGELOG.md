...
## Changed
  ...
  * Refactor to make the API more clear
  * Add the API section to the German documentation 
...
### Changed
  ...
  * Switch to gamslib 0.8.5
  * Switch to siegfried as default detector
...
### Changed
  ...
  * Add validate command to check object directories.
    
## [0.2.9] - 2025-11-21

### Changed

  * object.csv has a new colums 'tags'
  * 'csv create' has a new option '--use-subjects-as-tags'
